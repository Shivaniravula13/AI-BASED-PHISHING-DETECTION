    ...
    <div className="relative min-h-[calc(100-8rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 scanline">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-xl z-10 border border-gray-800">
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-bold text-white tracking-tight">Access Security Control</h2>
          <p className="text-gray-400 text-xs mt-1">Authenticate to access AI predictive intelligence dashboards</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-xs font-mono text-gray-400 uppercase tracking-widest">Password</label>
            </div>
